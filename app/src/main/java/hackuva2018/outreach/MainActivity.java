        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            ...
            switch (item.getItemId()) {
                case R.id.navigation_alert:
                    transaction.replace(R.id.content, new AlertFragment()).commit();
                    return true;
                case R.id.navigation_map:
                    transaction.replace(R.id.content, new MapFragment()).commit();
                    return true;
                case R.id.navigation_group:
                    transaction.replace(R.id.content, new GroupFragment()).commit();
                    return true;
                case R.id.navigation_recent_alerts:
                    transaction.replace(R.id.content, new RecentAlertFragment()).commit();
                    return true;
